...
<div style={{height:'10vh'}}  >
    <MDBFooter color='white' bgColor='black' >
      <MDBContainer className='text-center' style={{display:'flex',flexDirection:'column',top:'10px'}}>
              ...
              <MDBCol >
                <p style={{fontSize:'1.3rem',background:'black',marginBottom:"10px",color:'white'}} >
                  <strong>React Out</strong>
                </p>
              </MDBCol>
              <MDBCol >
                <MDBCol style={{fontSize:'0.8rem',background:'black'}} type='text' >
              ...
              <MDBCol >
                <MDBCol style={{fontSize:'0.8rem',background:'black'}} type='text' >
                 Phone Number:       +91- 7973274530
                </MDBCol>
                
              </MDBCol>
              <MDBCol >
                <MDBCol style={{fontSize:'0.8rem',background:'black'}} type='text' >
                 Email-Id:       vsptk20@gmail.com
                </MDBCol>
